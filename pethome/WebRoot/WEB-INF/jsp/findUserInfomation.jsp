					...
					<div class="personRight">
						...
						<div class="info">
							<table>
								<tr>
									<td>登录账号名：</td>
									<td><input class="in" type="text"
										value="<s:property value="model.uname" />" readonly="true" />
									</td>
								</tr>
								<tr>
									<td>邮箱：</td>
									<td><input class="in" type="text"
										value="<s:property value="model.email" />" readonly="true" />
									</td>
								</tr>
								<tr>
									<td>真实姓名：</td>
									<td><input class="in" type="text"
										value="<s:property value="model.relname" />" readonly="true" />
									</td>
								</tr>
								<tr>
									<td>手机号码：</td>
									<td><input class="in" type="text"
										value="<s:property value="model.tel" />" readonly="true" /></td>
								</tr>
							</table>
						</div>
					</div>
