...
<body>
	...
	<div class="page">
		<s:if test="pageBean.currentPage==1">
			...
			<a style="color: #f03"
				href="${pageContext.request.contextPath}/adminOrder_findAllAlreadyPaid.action?currentPage=1">首页</a>
		</s:if>
		<s:else>
			<a
				href="${pageContext.request.contextPath}/adminOrder_findAllAlreadyPaid.action?currentPage=<s:property value="pageBean.currentPage-1"/>">上一页</a>
		</s:else>
		<s:if test="pageBean.currentPage==pageBean.totalPage">
			<a
				href="${pageContext.request.contextPath}/adminOrder_findAllAlreadyPaid.action?currentPage=<s:property value="pageBean.totalPage"/>">尾页
			</a>

		</s:if>
		<s:else>
			<a
				href="${pageContext.request.contextPath}/adminOrder_findAllAlreadyPaid.action?currentPage=<s:property value="pageBean.currentPage+1"/>">下
