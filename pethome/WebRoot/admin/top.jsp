		...
		<div class="box">
			...
			<div class="top-nav">
				<ul>
					...
					<li><a
						href="${ pageContext.request.contextPath }/admin_exit.action"
						target="_top">退出</a></li>
					<li><a
						href="${ pageContext.request.contextPath }/admin_editPwd.action?aid=<s:property value="#session.existAdmin.aid"/>"
						target="right">修改密码</a></li>
					<li class="aname">您好！ <s:property
							value="#session.existAdmin.aname" /></li>
				</ul>
			</div>
			<div class="nav">
				<ul>
